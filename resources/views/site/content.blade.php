            ...
            @foreach($portfolios as $item)
                ...
                <!-- Portfolio Item -->
                    ...
                    <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;"
                         class="portfolio-item one-four  {{ $item->filters }} isotope-item">
        ...
        <div class="team_section clearfix">
            ...
            @foreach($peoples as $k=>$people)
                <div class="team_area">
                    ...
                    <h3 class="wow fadeInDown delay-0{{($k*3 +2)}}s">{{ $people->name }}</h3>
                    <span class="wow fadeInDown delay-0{{($k*3 +2)}}s">{{ $people->position }}</span>
                    <p class="wow fadeInDown delay-0{{($k*3 +2)}}s">{{ $people->text }}</p>
                </div>
            @endforeach
